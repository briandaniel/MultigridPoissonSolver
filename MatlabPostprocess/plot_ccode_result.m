...
dataFolder = '../Install/bin/';

intData = fopen([dataFolder,'intData.bin']);
datas = fopen([dataFolder,'data.bin']);
...
axis([0 yMax 0 xMax plotLims(1), plotLims(2)])
...
title ( '\Delta U = f; Uapprox' )
axis( [z(1) z(end) y(1) y(end)  plotLims(1), plotLims(2)])
